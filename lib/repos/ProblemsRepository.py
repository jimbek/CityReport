...
class ProblemsRepository(BaseRepository):
    ...
    def seed_db(self):
        super().seed_db('''
            ...
            INSERT OR IGNORE INTO problems (id, categoryId, stateId, title, description, latitude, longitude, createdAt, updatedAt, reportedByEmail) VALUES ("31625a2a-a9a3-41a9-9412-c5705341e081", "31625a2a-a9a3-41a9-9412-c5705341e071", "31625a2a-a9a3-41a9-9412-c5705341e060", "Κατεστραμμένος φωτισμός δρόμου", "Ο φωτισμός στο δρόμο Γ είναι κατεστραμμένος και δεν λειτουργεί τη νύχτα.", 37.9840, 23.7280, "2024-01-02T12:00:00", "2024-01-02T12:00:00", "");
            ...
            INSERT OR IGNORE INTO problems (id, categoryId, stateId, title, description, latitude, longitude, createdAt, updatedAt, reportedByEmail) VALUES ("31625a2a-a9a3-41a9-9412-c5705341e08b", "31625a2a-a9a3-41a9-9412-c5705341e071", "31625a2a-a9a3-41a9-9412-c5705341e062", "Κατεστραμμένος φωτισμός πεζοδρομίου", "Ο φωτισμός στο πεζοδρόμιο Ν είναι κατεστραμμένος και δεν λειτουργεί τη νύχτα.", 37.9890, 23.7330, "2024-01-12T17:00:00", "2024-01-12T17:00:00", "");
            ...
            INSERT OR IGNORE INTO problems (id, categoryId, stateId, title, description, latitude, longitude, createdAt, updatedAt, reportedByEmail) VALUES ("31625a2a-a9a3-41a9-9412-c5705341e090", "31625a2a-a9a3-41a9-9412-c5705341e071", "31625a2a-a9a3-41a9-9412-c5705341e063", "Κατεστραμμένος φωτισμός σε πάρκινγκ", "Ο φωτισμός στο πάρκινγκ Σ είναι κατεστραμμένος και δεν λειτουργεί τη νύχτα.", 37.9915, 23.7355, "2024-01-17T10:00:00", "2024-01-17T10:00:00", "");
            ...
            INSERT OR IGNORE INTO problems (id, categoryId, stateId, title, description, latitude, longitude, createdAt, updatedAt, reportedByEmail) VALUES ("31625a2a-a9a3-41a9-9412-c5705341e095", "31625a2a-a9a3-41a9-9412-c5705341e071", "31625a2a-a9a3-41a9-9412-c5705341e060", "Κατεστραμμένος φωτισμός σε πεζοδρόμιο", "Ο φωτισμός στο πεζοδρόμιο Χ είναι κατεστραμμένος και δεν λειτουργεί τη νύχτα.", 37.9940, 23.7380, "2024-01-22T20:00:00", "2024-01-22T20:00:00", "");
        ''')
