...
class ProblemsRepository(BaseRepository):
    ...
    def seed_db(self):
        super().seed_db('''
            ...
            INSERT OR IGNORE INTO problems (id, categoryId, stateId, title, description, latitude, longitude, createdAt, updatedAt) VALUES ("31625a2a-a9a3-41a9-9412-c5705341e082", "31625a2a-a9a3-41a9-9412-c5705341e072", "31625a2a-a9a3-41a9-9412-c5705341e060", "Βλάβη στο δίκτυο ύδρευσης", "Υπάρχει διαρροή στο δίκτυο ύδρευσης στην περιοχή Δ που προκαλεί πλημμύρα.", 37.9845, 23.7285, "2024-01-03T14:00:00", "2024-01-03T14:00:00");
            ...
            INSERT OR IGNORE INTO problems (id, categoryId, stateId, title, description, latitude, longitude, createdAt, updatedAt) VALUES ("31625a2a-a9a3-41a9-9412-c5705341e08c", "31625a2a-a9a3-41a9-9412-c5705341e072", "31625a2a-a9a3-41a9-9412-c5705341e060", "Βλάβη στο δίκτυο αποχέτευσης", "Υπάρχει βλάβη στο δίκτυο αποχέτευσης στην περιοχή Ξ που προκαλεί πλημμύρα.", 37.9895, 23.7335, "2024-01-13T19:00:00", "2024-01-13T19:00:00");
            ...
            INSERT OR IGNORE INTO problems (id, categoryId, stateId, title, description, latitude, longitude, createdAt, updatedAt) VALUES ("31625a2a-a9a3-41a9-9412-c5705341e094", "31625a2a-a9a3-41a9-9412-c5705341e070", "31625a2a-a9a3-41a9-9412-c5705341e060", "Καθαριότητα σε δημόσιο χώρο", "Ο δημόσιος χώρος Φ είναι γεμάτος σκουπίδια και χρειάζεται καθαρισμό.", 37.9935, 23.7375, "2024-01-21T18:00:00", "2024-01-21T18:00:00");
    ...
    def get_all_problems(self, categoryId: str = None, stateId: str = None, sortBy: str = None):
        query = '''
                SELECT problems.id, categoryId, stateId, title, description, latitude, longitude, createdAt, updatedAt, categories.label, states.label
                FROM problems
                JOIN categories
    ...
    def add_problem(self, data: dict):
        self.sql_command(f'''
                         INSERT INTO problems (id, categoryId, stateId, title, description, latitude, longitude, createdAt, updatedAt)
                         VALUES ("{data["id"]}", "{data["categoryId"]}", "{data["stateId"]}", "{data["title"]}", "{data["description"]}", {data["latitude"]}, {data["longitude"]}, "{data["createdAt"]}", "{data["updatedAt"]}")''')
    ...
    def update_problem(self, id: str, data: dict):
        ...
        self.sql_command(f'''
                         UPDATE problems
                         SET categoryId = "{data["categoryId"]}", stateId = "{data["stateId"]}", title = "{data["title"]}", description = "{data["description"]}", latitude = {data["latitude"]}, longitude = {data["longitude"]}, updatedAt = "{data["updatedAt"]}"
                         WHERE id = "{id}"''')
